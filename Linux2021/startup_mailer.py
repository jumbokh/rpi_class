...
# Account Information
to = '1101404110@nkust.edu.tw' # Email to send to.
gmail_user = 'jumbokh@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'get-from-Google' # Gmail password.
...
split_line_a = str(ip_lines[1]).split()
split_line_b = str(ip_lines[2]).split()
